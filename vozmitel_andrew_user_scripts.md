...
3. Если позьзователь нажимает на кнопку отметы то выполнить переход на шаг 1
...
5. Если позьзователь нажимает на кнопку отметы то выполнить переход на шаг 2
